...
namespace DamianGrembocki_Zadanie1
{
    public partial class Form1 : Form
    {
        ...
        {
            textBox2.Text = EncryptSecondAlgorithm(textBox1.Text);
        }

        private void button6_Click(object sender, EventArgs e)
        {
            textBox2.Text = DecryptSecondAlgorithm(textBox1.Text);
        }

        static readonly string PasswordHash = "P@@Sw0rd";
        static readonly string SaltKey = "S@LT&KEY";
        static readonly string VIKey = "@1B2c3D4e5F6g7H8";
        public static string EncryptSecondAlgorithm(string plainText)
        {
        ...
        public static string DecryptSecondAlgorithm(string encryptedText)
        {
